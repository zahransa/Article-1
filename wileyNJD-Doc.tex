...
\title{Performance of optically pumped magnetometers (OPMs)}
...
\abstract[Abstract]{Inorder to
propose a fair comparison of the performances of the two methods in MEG versus EEG, this study
considered realistic simulations of simultaneous EEG/MEG acquisitions taking into account an
equivalent number of channels in EEG (257electrodes) and MEG (275sensors), involving a biophysical
computational neural mass model of neuronal discharges and realistically shaped headmodels. Performance of the source localization
methods was assessed using a detection accuracy index (Area Under receiver operating characteristic
Curve,AUC) and a Spatial Dispersion (SD) metric.}
...
\begin{figure}
\centering
	\includegraphics[width=1\textwidth]{Additional Template files/figures/1.png}
